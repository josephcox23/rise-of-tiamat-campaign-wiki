...
The `upgrade` command supports the standard [[x_docs/cli/index|common flags]] (`--directory`, `--verbose`).

## See Also

- [[x_docs/cli/plugin|quartz plugin install --latest]] — update installed plugins
