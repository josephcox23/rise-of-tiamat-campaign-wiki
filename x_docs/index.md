...
Quartz requires **at least [Node](https://nodejs.org/) v22** and `npm` v10.9.2 to function correctly. Ensure you have these installed on your machine before continuing. See the [[x_docs/getting-started/index#Prerequisites|prerequisites]] for help installing them.
...
For the full walkthrough, see the [[x_docs/getting-started/index|Getting Started]] guide.
...
- [[Obsidian compatibility]], [[full-text search]], [[graph view]], [[wikilinks|wikilinks, transclusions]], [[x_docs/plugins/Backlinks]], [[x_docs/features/Latex|Latex]], [[syntax highlighting]], [[popover previews]], [[Docker Support]], [[i18n|internationalization]], [[x_docs/features/comments|comments]] and [many more](./features/) right out of the box
